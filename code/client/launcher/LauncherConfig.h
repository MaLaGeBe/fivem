...
#define CONTENT_URL "https://mirrors.fivem.net.cn/client"
#define CONTENT_URL_WIDE L"https://mirrors.fivem.net.cn/client"
#define GAME_EXECUTABLE L"GTA5.exe"
#elif defined(IS_RDR3)
#define PRODUCT_NAME L"RedM"
#define CONTENT_URL "https://mirrors.fivem.net.cn/redm"
#define CONTENT_URL_WIDE L"https://mirrors.fivem.net.cn/redm"
#define GAME_EXECUTABLE L"RDR2.exe"
#elif defined(IS_LAUNCHER)
#define PRODUCT_NAME L"Cfx.re Launcher"
#define CONTENT_URL "https://mirrors.fivem.net.cn/citfx"
#define CONTENT_URL_WIDE L"https://mirrors.fivem.net.cn/citfx"
